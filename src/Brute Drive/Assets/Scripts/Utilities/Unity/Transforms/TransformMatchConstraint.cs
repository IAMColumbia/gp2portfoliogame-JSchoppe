...
namespace BruteDrive.Utilities.Unity.Transforms
{
    /// <summary>
    ...
    public sealed class TransformMatchConstraint : MonoBehaviour
    {
        ...
        // TODO this selection is kind of jank.
        private void Update()
        {
            if (gameLoopType == UnityLoopType.Update)
                MatchTransform();
        }
        private void FixedUpdate()
        {
            if (gameLoopType == UnityLoopType.FixedUpdate)
                MatchTransform();
        }
